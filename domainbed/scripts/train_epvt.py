...
if __name__ == "__main__":
    ...
    for step in range(start_step, n_steps):
        ...
        if step %steps_per_epoch == 0 or (step == n_steps - 1):
            ...
            ACC, BACC, Prec, Rec, F1, AUC_ovo, SPEC, kappa, val_loss =misc.eval_indomain(algorithm, loader=evals, valid_df=val_df
                                                                                          ,batch_size=batch_size_eval
                                                                                          ,weights=weights, device=device, name=None, domain=None)
            val_acc = ACC
            val_roc = AUC_ovo
            ...
            if args.ood_vis:
                ...
                ACC, BACC, Prec, Rec, F1, AUC1, SPEC, kappa, val_loss = misc.eval_indomain(algorithm,
                                                                                           loader
                                                                                           =dataloaders_atlas_dermato[
                                                                                               'val'],
                                                                                           valid_df=test_ds_atlas_derm,
                                                                                           batch_size=REPLICAS,
                ...
                ACC, BACC, Prec, Rec, F1, AUC2, SPEC, kappa, val_loss = misc.eval_indomain(algorithm,
                                                                                           loader
                                                                                           =dataloaders_atlas_clin[
                                                                                               'val'],
                                                                                           valid_df=test_ds_atlas_clin,
                                                                                           batch_size=REPLICAS,
                                                                                           weights=weights, device=device,
                                                                                           name=None,
                                                                                           domain=None)
                ...
                ACC, BACC, Prec, Rec, F1, AUC3, SPEC, kappa, val_loss = misc.eval_indomain(algorithm,
                                                                                           loader=dataloaders_ph2
                                                                                               ['val'],
                                                                                           valid_df=test_ds_ph2,
                                                                                           batch_size=REPLICAS,
                                                                                           weights=weights, device=device,
                                                                                           name=None,
                                                                                           domain=None)
                ...
                ACC, BACC, Prec, Rec, F1, AUC4, SPEC, kappa, val_loss = misc.eval_indomain(algorithm,
                                                                                           loader=dataloaders_padufes
                                                                                               ['val'],
                                                                                           valid_df=test_ds_padufes,
                                                                                           batch_size=REPLICAS,
                                                                                           weights=weights, device=device,
                                                                                           name=None,
                                                                                           domain=None)
